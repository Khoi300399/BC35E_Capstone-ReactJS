...
const Header = () => {
    ...
    const renderGioHang = () => {
        if (userLogin) {
            return <NavLink className="nav-link-cart nav-flex nav-semi" to="/carts" aria-current="page">
                <img src="../img/cart.png" alt="..." />
                ({total})
            </NavLink>
        }

        return <NavLink className={'nav-link-cart nav-flex nav-semi'} to="/login">
           <img src="../img/cart.png" alt="..." />
           ({total})
        </NavLink>
    }
    ...
    const logOut = () => {     
            return <NavLink className={'nav-link'}  onClick={() => {
                huyStore(USER_LOGIN);
                eraseCookie(TOKEN);
                navigate("/home");
